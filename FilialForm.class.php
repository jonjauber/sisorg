...
class FilialForm extends TStandardForm
{
    ...
    function __construct()
    {
        ...
        $id_matriz = new TDBUniqueSearch('id_matriz', 'enfermeirovirtual', 'Matriz', 'id', 'nome');
        
        $id_matriz->setMask('{cnpj} - {nome}');
        $id_matriz->setMinLength(1);
        
        $btn = $this->form->addAction( _t('Save'), new TAction(array($this, 'onSave')), 'far:save');
        $btn->class = 'btn btn-sm btn-primary';
        $this->form->addActionLink( _t('Clear'), new TAction(array($this, 'onEdit')), 'fa:eraser red');
        $this->form->addActionLink( _t('Back'), new TAction(array('FilialList','onReload')), 'far:arrow-alt-circle-left blue');
        ...
        $id_matriz->addValidation('Matriz', new TRequiredValidator);
        ...
        $container->add(new TXMLBreadCrumb('menu.xml', 'FilialList'));
    ...
    public function onSave()
    {
        try
        {
            ...
            $object->id_matriz = $data->id_matriz;
