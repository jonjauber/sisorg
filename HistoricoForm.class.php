 ...
 */
class HistoricoForm extends TStandardForm
{
    protected $form; // form    
    ...
    function __construct()
    {
        ...
        parent::setActiveRecord('Historico');
        ...
        $this->form->addActionLink( _t('Back'), new TAction(array('HistoricoList','onReload')), 'far:arrow-alt-circle-left blue');
        ...
        $container->add(new TXMLBreadCrumb('menu.xml', 'HistoricoList'));
