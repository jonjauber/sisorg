 ...
 */
class MatrizList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('Matriz');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Matriz');
        ...
        $this->form->addAction(_t('New'),  new TAction(array('MatrizForm', 'onEdit')), 'fa:plus green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('MatrizForm', 'onEdit'));
